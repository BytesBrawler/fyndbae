    ...
    <div className="container mx-auto px-4 py-12 md:py-16">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl md:text-4xl font-bold text-center mb-8 text-app-text-primary">
          Terms and <span className="text-app-primary">Conditions</span>
        </h1>

        <div className="glass-card rounded-lg p-6 md:p-8">
          <p className="text-app-text-secondary mb-6">Last updated on 08-04-2025 08:39:18</p>

          <div className="prose max-w-none prose-invert prose-headings:text-app-primary prose-p:text-app-text-secondary">
            <p>
              These Terms and Conditions, along with privacy policy or other terms ("Terms") constitute a binding
              agreement by and between SURINDER KUMAR, ( "Website Owner" or "we" or "us" or "our") and you ("you" or
            ...
            <p>
              ...
              refund claim within the stipulated time, than this would make you ineligible for a refund.
            </p>
            ...
            <p>
              ...
              jurisdiction of the courts in ROHTAK, HARYANA
            </p>
