      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 md:p-8">
          <p className="text-gray-600 mb-6">
            Last updated on 08-04-2025 08:39:18
          </p>

          <div className="prose max-w-none">
            <p>
              These Terms and Conditions, along with the privacy policy or other terms ("Terms"), constitute a binding agreement by and between SURINDER KUMAR ("Website Owner" or "we" or "us" or "our") and you ("you" or "your") and relate to your use of our website, goods (as applicable), or services (as applicable) (collectively, "Services").
            </p>
            ...
            <p>
              All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in ROHTAK, HARYANA.
            </p>
